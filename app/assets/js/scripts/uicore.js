        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/rlatn1234/rMCLauncher/releases/download/v${info.version}/rMClauncher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : ''}.dmg`
                    showUpdateUI(info)
                }
